...
= 7.6.1 - 2025-10-28 =
* **Fixed:** Ensure field data is set properly before we use it. Resolves a fatal error with Elementor (props [@ktorktor](https://github.com/ktorktor), [@dkotter](https://github.com/dkotter) via [#371](https://github.com/10up/restricted-site-access/pull/371)).
