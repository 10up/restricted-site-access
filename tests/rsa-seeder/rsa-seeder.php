...
function my_rsa_feed_override( $is_restricted, $wp ) {
	...
	if ( in_array( $wp->request, $unrestrcited_routes ) ) {
		$is_restricted = false;
	}
...
add_action( 'rest_api_init', function () {
	...
	register_rest_route( 'rsa/v1', 'seed/activation-deactivation', array(
		'methods' => 'GET',
		'callback' => function() {
	...
	register_rest_route( 'rsa/v1', 'seed/add-invalid-addresses', array(
		'methods' => 'GET',
	...
	register_rest_route( 'rsa/v1', 'seed/add-valid-addresses', array(
		'methods' => 'GET',
		'callback' => function() use ( $mock_rsa_mode, $mock_blog_public, $mock_rsa_options ) {
			update_site_option( 'rsa_mode', $mock_rsa_mode );
			update_site_option( 'blog_public', $mock_blog_public );
	...
	register_rest_route( 'rsa/v1', 'seed/allow-unrestricted-users', array(
		'methods' => 'GET',
		'callback' => function() use ( $mock_rsa_mode, $mock_blog_public, $mock_rsa_options ) {
			update_site_option( 'rsa_mode', $mock_rsa_mode );
			update_site_option( 'blog_public', $mock_blog_public );
	...
	register_rest_route( 'rsa/v1', 'seed/allow-unrestricted-users/show-simple-message', array(
		'methods' => 'GET',
		'callback' => function() use ( $mock_rsa_mode, $mock_blog_public, $mock_rsa_options ) {
	...
	register_rest_route( 'rsa/v1', 'seed/allow-unrestricted-users/redirect-to-web-address', array(
		'methods' => 'GET',
		'callback' => function() use ( $mock_rsa_mode, $mock_blog_public, $mock_rsa_options ) {
	...
	register_rest_route( 'rsa/v1', 'seed/allow-unrestricted-users/send-to-login-screen', array(
		'methods' => 'GET',
		'callback' => function() use ( $mock_rsa_mode, $mock_blog_public, $mock_rsa_options ) {
	...
	register_rest_route( 'rsa/v1', 'seed/restrict-users/send-to-login-screen', array(
		'methods' => 'GET',
		'callback' => function() use ( $mock_rsa_mode, $mock_blog_public, $mock_rsa_options ) {
			$mock_rsa_options['approach'] = 1;
			$mock_rsa_options['redirect_url'] = 'http://localhost:8889/page-to-redirect/';
	...
	register_rest_route( 'rsa/v1', 'seed/restrict-users/redirect-to-web-address/with-301', array(
		'methods' => 'GET',
		'callback' => function() use ( $mock_rsa_mode, $mock_blog_public, $mock_rsa_options ) {
			$mock_rsa_options['approach'] = 2;
	...
	register_rest_route( 'rsa/v1', 'seed/restrict-users/redirect-to-web-address/with-302', array(
		'methods' => 'GET',
		'callback' => function() use ( $mock_rsa_mode, $mock_blog_public, $mock_rsa_options ) {
			$mock_rsa_options['approach'] = 2;
	...
	register_rest_route( 'rsa/v1', 'seed/restrict-users/redirect-to-web-address/with-307', array(
		'methods' => 'GET',
		'callback' => function() use ( $mock_rsa_mode, $mock_blog_public, $mock_rsa_options ) {
			$mock_rsa_options['approach'] = 2;
	...
	register_rest_route( 'rsa/v1', 'seed/restrict-users/show-simple-message', array(
		'methods' => 'GET',
		'callback' => function() use ( $mock_rsa_mode, $mock_blog_public, $mock_rsa_options ) {
			$mock_rsa_options['approach'] = 3;
			$mock_rsa_options['allowed'] = array(
